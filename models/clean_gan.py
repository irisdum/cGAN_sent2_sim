...
class GAN():
    ...
    def train(self):
        ...
        valid = np.ones((self.global_batch_size, 30, 30, 1))  # because of the shape output of the discriminator
    ...
    def predict_on_iter(self, batch, path_save, l_image_id=None, generator=None):
